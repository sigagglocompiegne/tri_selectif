...
- [Fichier hors gabarit des lieux de collecte et des conteneurs Verre à télécharger au format csv (non géographique)](/gabarit/lieu_pav.zip)
- [Fichier hors gabarit des lieux de collecte à télécharger au format shape (géographique)](/gabarit/lieu_de_collecte.zip)
- [Fichier gabarit Qgis 3.x (vierge) complet à télécharger](/gabarit/gabarit_qgis_pav.zip)
