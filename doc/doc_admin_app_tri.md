...
|:---|:-:|:-:|:---|:---|:---|:---|
|affiche_message_eve  |x|x||Formate le contenu affiché dans le fiche d'information du lieu dans l'onglet Evènement|Résultat de recherche|
`CASE WHEN (SELECT count(*) FROM m_dechet.an_dec_pav_cont WHERE idlieu = {idlieu} AND eve IN ('20','30','31')) > 0 THEN '' ELSE '<font size=3><b>Pas d''évènements de conteneurs enregistrés sur ce lieu de collecte</b></font>' END`|
